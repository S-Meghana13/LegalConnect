...
const ConnectPage = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm bg-white shadow-lg rounded-lg px-4 py-6">
        <button
          onClick={handleBack}
          className="mb-4 px-4 py-2 text-white font-medium rounded"
          style={{ backgroundColor: "#2563eb", fontStyle: "normal" }}
        >
          Go Back
        </button>

        <h3 className="text-2xl font-bold text-center mb-4" style={{ fontStyle: "normal" }}>
          Connect with {name}
        </h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-sm">
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 text-white font-medium text-sm rounded hover:bg-blue-700"
            style={{ backgroundColor: "#2563eb", fontStyle: "normal" }}
          >
            Submit Request
          </button>
